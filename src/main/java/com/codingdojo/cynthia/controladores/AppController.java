...
public class AppController {
	...
	public String guardar_pregunta(@Valid @ModelAttribute("question") Question question,
		...
		if(result.hasErrors()) {
			...
			//listaEtiquetas = {"programacion", "tecnologia", "computadora"};
	...
	public String nueva_respuesta(@PathVariable("id") Long id,
								  Model model,
	...
	public String guardar_respuesta(@PathVariable("id") Long id,
